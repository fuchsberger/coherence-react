defmodule Coherence.Mixfile do
  ...
  def project do
    [ app: :coherence,
      ...
      name: "Coherence React",
      description: """
      A full featured, configurable authentication and user management system
      for Phoenix using React and Reactstrap.
      """
    ]
  end
  ...
  defp package do
    [ maintainers: ["Alexander Fuchsberger"],
      licenses: ["MIT"],
      links: %{ "Github" => "https://github.com/sathras/coherence-react" },
