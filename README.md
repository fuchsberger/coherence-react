...
> This version is in active development. The Readme will be added soon.
>

Coherence React is a full featured, configurable authentication system for Phoenix, based on [Coherence](https://github.com/smpallen99/coherence), with the following modules:
...
defmodule MyProjectWeb.Router do
  ...
  scope "/" do
    ...
    coherence_routes()
    get "/*path",  MyProjectWeb.PageController, :index
  end
end
```
...
* Detailed Example [Coherence-React Demo](https://github.com/smpallen99/coherence_demo) comming soon
